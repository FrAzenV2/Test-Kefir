...
namespace Source.Scripts
{
    public class ShipFactory
    {
        ...
        public Entity Create()
        {
            ...
            var entity = new Entity(EntityType.Player);
            
            var movementComponent = new ShipMovementComponent(_inputState, _shipMovementConfig, Vector2.zero, Vector2.zero, 0);
            var shootingComponent = new ShipShootingComponent(_shootingConfig, _bulletFactory, _inputState, ref movementComponent.MovementData);
