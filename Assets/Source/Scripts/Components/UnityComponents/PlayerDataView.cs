...
namespace Source.Scripts.Components.UnityComponents
{
    public class PlayerDataView : MonoBehaviour
    {
        ...
        public void UpdateTotalTime(int time)
        {
            ...
            foreach (var totalTimeText in _totalTimeTexts)
            {
                totalTimeText.SetText(_stringBuilder);
            }
        }
        ...
        public void UpdateTotalScore(int score)
        {
            ...
            foreach (var totalScoreText in _totalScoreTexts)
            {
                totalScoreText.SetText(_stringBuilder);
            }
        }
